...
void i2s_channel_init() {
    ...
    i2s_pdm_rx_config_t pdm_rx_cfg = {
        ...
        .slot_cfg = {
            ...
            .slot_mode = I2S_SLOT_MODE_STEREO, // it copies data twice and write into dma, need to find a better way
...
void i2s_clk_init() {
    ...
    i2s_pdm_rx_clk_config_t pdm_rx_clk_cfg = I2S_PDM_RX_CLK_DEFAULT_CONFIG(PDM_RX_FREQ_HZ);
    i2s_channel_reconfig_pdm_rx_clock(rx_chan,&pdm_rx_clk_cfg);
...
#define N_mic_circular_buf 16
#define mic_block_size (4096+4)
#define AUDIO_BUF_BYTES mic_block_size

static uint8_t mic_cbuf[N_mic_circular_buf*mic_block_size]; 
